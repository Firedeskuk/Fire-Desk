...
`npm install`, `npm run dev`, `npm run build`, `npm run lint`, `npm run typecheck`, `npm test`. Always say which one, and ask them to paste back the last 20 lines of output, error or not.
